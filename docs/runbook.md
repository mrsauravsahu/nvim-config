...
| `<leader>z` | Close all file buffers (keeps NvimTree state) — see [General Mappings](#general-mappings) |
| `<leader>b` | New buffer |
...
| `<leader>z` | **Close all file tabs**, keeping NvimTree as-is |

## `<leader>z` — close all file tabs
